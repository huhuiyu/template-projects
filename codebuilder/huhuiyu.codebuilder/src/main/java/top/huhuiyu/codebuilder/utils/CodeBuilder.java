...
public class CodeBuilder {
  ...
  private void buildFile(TemplateInfo templateInfo, TemplatePathInfo templatePathInfo, List<File> files, String name) throws Exception {
    ...
    if (templateInfo.getSubpackage() == null) {
      ...
      outfile = new File(
          CodeBuilderUtil.joinFilePath(outputDir, builderConfigInfo.getProjectName(), templateInfo.getOutpath(), FileUtil.parsePackage(builderUtil.getSubPackage(templateInfo.getSubpackage())), name));
    }
  ...
  private void buildTable(TemplateInfo templateInfo, TemplatePathInfo templatePathInfo, List<File> files, String name) throws Exception {
    ...
    for (TableInfo tableInfo : tables) {
      ...
      if (templateInfo.getSubpackage() == null) {
        ...
        outfile = new File(CodeBuilderUtil.joinFilePath(outputDir, builderConfigInfo.getProjectName(), templateInfo.getOutpath(),
            FileUtil.parsePackage(builderUtil.getSubPackage(templateInfo.getSubpackage())), filename));
      }
