...
public class XmlBeanUtil {
  ...
  private Map<String, Class<?>> useAttrMap = new HashMap<>();
  ...
  public File saveData(Object data) throws Exception {
    ...
    OutputStreamWriter osw = new OutputStreamWriter(new FileOutputStream(file), FileUtil.DEFAULT_ENCODING);
  ...
  public Object loadData(InputStream inputStream) throws Exception {
    XStream xStream = getXStream();
    Object o = xStream.fromXML(new InputStreamReader(inputStream, FileUtil.DEFAULT_ENCODING));
    return o;
  }
