package top.huhuiyu.api.frame.panel;
...
public class GridBagPanel extends JPanel {
   ...
   * @param row       行数
   * @param column    列数
   * @param weightx   行的权重(不修改输入就输入1)
   * @param weighty   列的权重(不修改输入就输入1)
   */
  public void addComponent(Component component, int row, int column, double weightx, double weighty) {
    resetConstraints();
    g.gridx = column;
    g.gridy = row;
    g.weightx = weightx;
   ...
   * @param weighty   列的权重(不修改输入就输入1)
   */
  public void addComponent(Component component, int row, int column, int width, int height, double weightx, double weighty) {
    resetConstraints();
    g.gridx = column;
    g.gridy = row;
    g.gridwidth = width;
