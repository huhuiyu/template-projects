package top.huhuiyu.api.freemarker;
...
public class FreemarkerUtilBean {
   ...
   * @throws Exception 处理发生异常
   */
  public void process(String templateName, Map<String, Object> map, OutputStream out, boolean close) throws Exception {
